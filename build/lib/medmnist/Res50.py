...
class ResNet50BasicBlock(nn.Module):
    def __init__(self, in_channel, outs, kernerl_size, stride, padding):
        ...
        self.conv1 = nn.Conv2d(in_channel, outs[0], kernel_size=3, stride=1, padding=1)
        self.bn1 = nn.BatchNorm2d(outs[0])
        self.conv2 = nn.Conv2d(outs[0], outs[1], kernel_size=3, stride=1, padding=1)
        self.bn2 = nn.BatchNorm2d(outs[1])
        self.conv3 = nn.Conv2d(outs[1], outs[2], kernel_size=3, stride=1, padding=1)
